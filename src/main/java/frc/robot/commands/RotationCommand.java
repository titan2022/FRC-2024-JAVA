...
public class RotationCommand extends Command implements VariantCommand{
    ...
    public RotationalDrivebase drivebase;
    public Localizer localizer;
    public Rotation2d omega;
    public Rotation2d theta;
    public Rotation2d targetAngle;

    public RotationCommand(RotationalDrivebase driveBase, Localizer localizer) {
    ...
    public void changeColorSide() {
        theta = new Rotation2d(-theta.getRadians());
        omega = new Rotation2d(-omega.getRadians());
    }
}
