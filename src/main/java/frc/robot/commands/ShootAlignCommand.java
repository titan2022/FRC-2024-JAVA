...
// import edu.wpi.first.wpilibj.Driveration.Alliance;
...
//     private final TranslationalDrivebase translationalDrivebase;
//     private int side = 0;
//     private boolean toggled = false;
//     private Translation2d[] speaker_location = {new Translation2d(0, 0), new Translation2d(0, 0)};
//     private static final double dz = 1.6764;
//     private static final double g = 9.80665;

//     public ShootAlignCommand(ShooterSubsystem shooter, RotationalDrivebase rotationalDrivebase, Localizer localizer, XboxController xbox, TranslationalDrivebase translationalDrivebase){
//         this.shooter = shooter;
//         this.rotationalDrivebase = rotationalDrivebase;
//         this.localizer = localizer;
//         this.xbox = xbox;
//         this.translationalDrivebase = translationalDrivebase;
...
//         Translation2d speakerPosition = speaker_location[side];
//         Translation2d speakerDistance = speakerPosition.minus(position);
//         double shooting_v = 47;
//         Pair<Rotation2d, Rotation2d> angles = getAngles(speakerPosition, shooting_v, translationalDrivebase.getVelocity());
//         shooter.setRotation(angles.getFirst().getRadians());
//         // rotationalDrivebase.setRotation(angles.getSecond().getRadians());
//     }
